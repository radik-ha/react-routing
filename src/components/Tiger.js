import tigerImg from "../imgs/tiger.jpg";

export default function Tiger() {
	return(
        <div Class="first">
            <h1>TIGER</h1>
            <img src={tigerImg} alt=""/>
            <p>
...
Etymology
The Old English tigras derives from Old French tigre, from Latin tigris, which was a borrowing from Classical Greek τίγρις 'tigris'.[4] Since ancient times, the word tigris has been suggested to originate from the Armenian or Persian word for 'arrow', which may also be the origin of the name for the river Tigris.[5][6] However, today, the names are thought to be homonyms, and the connection between the tiger and the river is doubted.
            </p>
        </div>
       );
}